...
# V4
@configclass
class CustomLite3RearBalanceEnvCfg_3(DeeproboticsLite3RoughEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        ...
        # Pénaliser spécifiquement l'hyperextension des HipY avant
        self.rewards.front_legs_extended = RewardTermCfg(
            func=mdp.front_legs_extended,
            weight=-2.0,
            params={
        ...
        # Ralentir les changements brusques d'action — anti mouvement parasite
        self.rewards.action_rate_l2.weight = -0.05  # parent est à -0.02, on renforce
        ...
        if self.__class__.__name__ == "CustomLite3RearBalanceEnvCfg_3":
            self.disable_zero_weight_rewards()